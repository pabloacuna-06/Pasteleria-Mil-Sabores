const productos = [
  { codigo: "TC001", nombre: "Torta Cuadrada de Chocolate", categoria: "Tortas Cuadradas", precio: 45000, descripcion: "Deliciosa torta de chocolate con capas de ganache y un toque de avellanas. Personalizable con mensajes especiales.", imagen: "https://upload.wikimedia.org/wikipedia/commons/4/45/Square_Piece_of_Chocolate_Cake_%2828157518369%29.jpg" },
  { codigo: "TC002", nombre: "Torta Cuadrada de Frutas", categoria: "Tortas Cuadradas", precio: 50000, descripcion: "Una mezcla de frutas frescas y crema chantilly sobre un suave bizcocho de vainilla, ideal para celebraciones.", imagen: "https://upload.wikimedia.org/wikipedia/commons/d/d7/Fruit_cake%281%29.jpg" },
  ...
  { codigo: "TT002", nombre: "Torta Circular de Manjar", categoria: "Tortas Circulares", precio: 42000, descripcion: "Torta tradicional chilena con manjar y nueces, un deleite para los amantes de los sabores dulces y clásicos.", imagen: "https://upload.wikimedia.org/wikipedia/commons/3/3d/Torta_de_Chocolate_y_Dulce_de_Leche_San_Martin_de_los_Andes.JPG" },
  { codigo: "PI001", nombre: "Mousse de Chocolate", categoria: "Postres Individuales", precio: 5000, descripcion: "Postre individual cremoso y suave, hecho con chocolate de alta calidad, ideal para los amantes del chocolate.", imagen: "https://upload.wikimedia.org/wikipedia/commons/b/b9/Chocolate_mousse_%2816013444604%29.jpg" },
  { codigo: "PI002", nombre: "Tiramisú Clásico", categoria: "Postres Individuales", precio: 5500, descripcion: "Un postre italiano individual con capas de café, mascarpone y cacao, perfecto para finalizar cualquier comida.", imagen: "https://upload.wikimedia.org/wikipedia/commons/e/e4/001_Tiramisu.jpg" },
  ...
  { codigo: "PSA002", nombre: "Cheesecake Sin Azúcar", categoria: "Productos Sin Azúcar", precio: 47000, descripcion: "Suave y cremoso, este cheesecake es una opción perfecta para disfrutar sin culpa.", imagen: "https://upload.wikimedia.org/wikipedia/commons/5/5b/Plain_New_York-style_cheesecake.JPG" },
  { codigo: "PT001", nombre: "Empanada de Manzana", categoria: "Pastelería Tradicional", precio: 3000, descripcion: "Pastelería tradicional rellena de manzanas especiadas, perfecta para un dulce desayuno o merienda.", imagen: "https://upload.wikimedia.org/wikipedia/commons/7/77/Pastry-Turnover-Apple.jpg" },
  { codigo: "PT002", nombre: "Tarta de Santiago", categoria: "Pastelería Tradicional", precio: 6000, descripcion: "Tradicional tarta española hecha con almendras, azúcar, y huevos, una delicia para los amantes de los postres clásicos.", imagen: "https://upload.wikimedia.org/wikipedia/commons/c/ce/Tarta_de_Santiago-2009.jpg" },
  { codigo: "PG001", nombre: "Brownie Sin Gluten", categoria: "Productos Sin Gluten", precio: 4000, descripcion: "Rico y denso, este brownie es perfecto para quienes necesitan evitar el gluten sin sacrificar el sabor.", imagen: "https://upload.wikimedia.org/wikipedia/commons/a/af/Brownie_%281%29.jpg" },
  { codigo: "PG002", nombre: "Pan Sin Gluten", categoria: "Productos Sin Gluten", precio: 3500, descripcion: "Suave y esponjoso, ideal para sándwiches o para acompañar cualquier comida.", imagen: "https://upload.wikimedia.org/wikipedia/commons/f/fc/Non_gluten_bread.jpg" },
  { codigo: "PV001", nombre: "Torta Vegana de Chocolate", categoria: "Productos Vegana", precio: 50000, descripcion: "Torta de chocolate húmeda y deliciosa, hecha sin productos de origen animal, perfecta para veganos.", imagen: "https://upload.wikimedia.org/wikipedia/commons/c/c6/Vegan_Chocolate_Cake.jpg" },
  { codigo: "PV002", nombre: "Galletas Veganas de Avena", categoria: "Productos Vegana", precio: 4500, descripcion: "Crujientes y sabrosas, estas galletas son una excelente opción para un snack saludable y vegano.", imagen: "https://upload.wikimedia.org/wikipedia/commons/8/82/Oatmeal_cookies_on_a_plate.jpg" },
  ...
  { codigo: "TE002", nombre: "Torta Especial de Boda", categoria: "Tortas Especiales", precio: 60000, descripcion: "Elegante y deliciosa, esta torta está diseñada para ser el centro de atención en cualquier boda.", imagen: "https://upload.wikimedia.org/wikipedia/commons/b/b6/Wedding_cake_-_Kathmandu%2C_Nepal_on_2018.jpg" }
];
